...
_MEDIA_COLS = "id, id_on_platform, url_suffix, platform, post_id, local_url, media_type, data, annotation, thumbnail_path, thumbnail_status, create_date"
_MEDIA_COLS_NO_DATA = "id, id_on_platform, url_suffix, platform, post_id, local_url, media_type, NULL AS data, annotation, thumbnail_path, thumbnail_status, create_date"
