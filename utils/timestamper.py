...
def ensure_openssl_on_path():
    ...
    openssl_dir = None
    has_stored_path = Path("opentimestamps/open_ssl_location.txt").exists()
    if has_stored_path:
        with open("opentimestamps/open_ssl_location.txt", "r", encoding="utf-8") as f:
    ...
    if not openssl_exe_exists:
        ...
        with open("opentimestamps/open_ssl_location.txt", "w", encoding="utf-8") as f:
