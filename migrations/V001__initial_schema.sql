-- =============================================================================
-- V001: Initial schema
-- This reflects the full database state as of the introduction of the
-- migration system, incorporating all ad-hoc changes previously applied
-- manually (archive_session refactoring, incorporation_job, url_parts
-- fulltext indexes, entity_share_link index, etc.).
-- =============================================================================
...
(
    ...
    incorporation_status      enum ('pending', 'parse_failed', 'parsed', 'extract_failed', 'done')
